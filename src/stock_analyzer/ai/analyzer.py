...
5. **风险优先级**：舆情中的风险点要醒目标出"""
    ...
    def __init__(self, api_key: str | None = None):
        ...
        # 两者都未配置
        if not getattr(self, "_genai_client", None) and not self._openai_client:
    ...
    def _switch_to_fallback_model(self) -> bool:
        ...
        try:
            ...
            # Assert for type checker - _genai_client is not None here
            assert self._genai_client is not None, "Gemini client should be initialized"
    ...
    def is_available(self) -> bool:
        """检查分析器是否可用"""
        return getattr(self, "_genai_client", None) is not None or self._openai_client is not None
    ...
    def analyze(self, context: dict[str, Any], news_context: str | None = None) -> AnalysisResult:
        ...
        try:
            ...
            # 获取模型名称
            model_name = getattr(self, "_current_model_name", None) or "unknown"
