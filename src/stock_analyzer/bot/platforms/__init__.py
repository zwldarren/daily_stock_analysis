...
from stock_analyzer.bot.platforms.base import BotPlatform
from stock_analyzer.bot.platforms.dingtalk import DingtalkPlatform
...
# 钉钉 Stream 模式（可选）
try:
    from stock_analyzer.bot.platforms.dingtalk_stream import (
