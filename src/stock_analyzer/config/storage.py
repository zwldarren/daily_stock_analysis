...
This module provides utilities for saving configuration to .env files.
Database storage has been moved to infrastructure layer following DDD principles.
"""
...
class ConfigConverter:
    ...
    def to_dict(self, config: Config) -> dict[str, Any]:
        ...
        if notify.wechat_webhook_url:
            result["WECHAT_WEBHOOK_URL"] = notify.wechat_webhook_url
        if notify.feishu_webhook_url:
            result["FEISHU_WEBHOOK_URL"] = notify.feishu_webhook_url
