            ...
            for fetcher in self._fetchers:
                if fetcher.name == "YfinanceFetcher":
                    if hasattr(fetcher, "get_realtime_quote"):
                        try:
                            quote = fetcher.get_realtime_quote(stock_code)  # type: ignore[operator]
                ...
                if source == "efinance":
                    ...
                    for fetcher in self._fetchers:
                        if fetcher.name == "AkshareFetcher":
                            if hasattr(fetcher, "get_realtime_quote"):
                                quote = fetcher.get_realtime_quote(stock_code, source="em")  # type: ignore[operator]
                            break
                    ...
                    for fetcher in self._fetchers:
                        if fetcher.name == "AkshareFetcher":
                            if hasattr(fetcher, "get_realtime_quote"):
                                quote = fetcher.get_realtime_quote(stock_code, source="sina")  # type: ignore[operator]
                            break
                    ...
                    for fetcher in self._fetchers:
                        if fetcher.name == "AkshareFetcher":
                            if hasattr(fetcher, "get_realtime_quote"):
                                quote = fetcher.get_realtime_quote(stock_code, source="tencent")  # type: ignore[operator]
                            break
                ...
                for fetcher in self._fetchers:
                    if fetcher.name == fetcher_name:
                        if hasattr(fetcher, "get_chip_distribution"):
                            chip = fetcher.get_chip_distribution(stock_code)  # type: ignore[operator]
                            if chip is not None:
    ...
    def get_stock_name(self, stock_code: str) -> str | None:
        ...
        for fetcher in self._fetchers:
            if hasattr(fetcher, "get_stock_name"):
                try:
                    name = fetcher.get_stock_name(stock_code)  # type: ignore[operator]
                    if name:
                        self._stock_name_cache[stock_code] = name
    ...
    def batch_get_stock_names(self, stock_codes: list[str]) -> dict[str, str]:
        ...
        for fetcher in self._fetchers:
            if hasattr(fetcher, "get_stock_list") and missing_codes:
                try:
                    stock_list = fetcher.get_stock_list()  # type: ignore[operator]
